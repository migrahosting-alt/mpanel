...
const navigation = [
  ...
  { name: 'My Services', href: '/client/services', icon: ServerIcon },
  { name: 'Domains', href: '/client/domains', icon: GlobeAltIcon },
  { name: 'Invoices', href: '/client/invoices', icon: DocumentTextIcon },
  { name: 'Billing', href: '/client/billing', icon: CreditCardIcon },
  { name: 'Support', href: '/client/support', icon: LifebuoyIcon },
];
                  ...
                  <div className="flex h-16 shrink-0 items-center border-b border-gray-200">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.target.src = 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 40"%3E%3Ctext x="10" y="30" font-family="Arial" font-size="24" font-weight="bold" fill="%232563eb"%3EMigraHosting%3C/text%3E%3C/svg%3E';
                      }}
                    />
                  </div>
