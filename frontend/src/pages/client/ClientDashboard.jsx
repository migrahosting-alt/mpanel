...
const ClientDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch services
      const servicesRes = await fetch('http://localhost:3000/api/client/services', {
      ...
      // Fetch domains
      const domainsRes = await fetch('http://localhost:3000/api/client/domains', {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (domainsRes.ok) {
      ...
      // Fetch invoices
      const invoicesRes = await fetch('http://localhost:3000/api/client/invoices', {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (invoicesRes.ok) {
      ...
      const ticketsRes = await fetch('http://localhost:3000/api/client/tickets', {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (ticketsRes.ok) {
