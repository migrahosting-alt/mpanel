...
export const AuthProvider = ({ children }: { children: any }) => {
  ...
  const isAdmin = userRole?.name === 'admin' || userRole?.name === 'super_admin' || user?.role === 'admin' || user?.role === 'super_admin';
  const isSuperAdmin = userRole?.name === 'super_admin' || user?.role === 'super_admin';
