...
function App() {
  ...
  return (
    <Routes>
      ...
      {/* Admin-only routes - Always registered, protected by adminOnly prop */}
      <Route path="/admin" element={<Navigate to="/" replace />} />
      <Route path="/admin/" element={<Navigate to="/" replace />} />
      <Route path="/admin/users" element={<ProtectedRoute adminOnly><UsersPage /></ProtectedRoute>} />
      <Route path="/admin/customers" element={<ProtectedRoute adminOnly><CustomersPage /></ProtectedRoute>} />
      <Route path="/admin/guardian" element={<ProtectedRoute adminOnly><GuardianManagement /></ProtectedRoute>} />
