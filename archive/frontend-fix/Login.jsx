...
export default function Login() {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0A0118] via-[#1a0a2e] to-[#0A0118]">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#8A4DFF] mx-auto"></div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0A0118] via-[#1a0a2e] to-[#0A0118] px-4">
      <div className="w-full max-w-md">
        ...
        {/* Back to website */}
        <div className="mt-6 text-center">
          <a href="https://migrahosting.com" className="text-sm text-gray-400 hover:text-white transition-colors">
