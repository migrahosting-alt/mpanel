...
router.post('/branding', auth, async (req, res) => {
  try {
...
router.patch('/branding/:id', auth, async (req, res) => {
  try {
...
router.get('/branding/portal-url', auth, async (req, res) => {
  try {
...
router.get('/resellers/:id', auth, async (req, res) => {
  try {
    const result = await require('../config/database').query(
...
router.get('/resellers/:id/hierarchy', auth, async (req, res) => {
  try {
...
// Update reseller
router.patch('/resellers/:id', auth, async (req, res) => {
  try {
...
router.post('/commissions/calculate', auth, async (req, res) => {
  try {
...
router.get('/resellers/:id/commissions', auth, async (req, res) => {
  try {
...
router.post('/resellers/:id/payouts', auth, async (req, res) => {
  try {
...
router.get('/resellers/:id/payouts', auth, async (req, res) => {
  try {
    const result = await require('../config/database').query(
...
router.post('/resellers/:id/pricing', auth, async (req, res) => {
  try {
...
router.get('/resellers/:id/pricing/:productType', auth, async (req, res) => {
  try {
...
router.get('/resellers/:id/dashboard', auth, async (req, res) => {
  try {
